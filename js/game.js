function hideClass(name) {
    ...
    */
    ...
    this.quizQuestions = {
    easy: [
    {topic: 'Combinacion lineal', mode: 'tf', statement: 'El vector (0,0,3) es combinacion lineal de (0,0,1).', answer: 'verdadero', explanation: 'Si consideramos (0,0,3) = 3(0,0,1), entonces si es combinacion lineal con coeficiente c=3.'},
    {topic: 'Combinacion lineal', mode: 'tf', statement: 'El vector (1,0,4) es combinacion lineal de (1,0,1) y (0,0,2).', answer: 'verdadero', explanation: 'Podemos escribir (1,0,4) = 1(1,0,1) + 3/2(0,0,2), por lo tanto si es combinacion lineal.'},
    {topic: 'Base y dimension', mode: 'single', statement: 'Para que valores de a los vectores u=(1,1,1), v=(1,a,1), w=(1,1,a) formen una base de R^3?', options: ['si a = 1', 'si a ≠ 1', 'solo si a = 0', 'solo si a > 1'], answerIndex: 1, explanation: 'El determinante se anula cuando a=1, por lo que para formar base se requiere que a≠1.'},
    {topic: 'Bases', mode: 'single', statement: 'La base canonica de R^2 esta formada por los vectores:', options: ['(1,0) y (0,2)', '(2,0) y (0,2)', '(1,0) y (0,1)', '(1,1) y (1,-1)'], answerIndex: 2, explanation: 'Los vectores i=(1,0) y j=(0,1) son perpendiculares, de modulo 1, y generan todo R^2.'},
    {topic: 'Integrales definidas', mode: 'tf', statement: 'Para calcular el area entre y=-x^2+2x+3 y el eje x en [-1,3], se integra la funcion tal cual.', answer: 'verdadero', explanation: 'Como la funcion es no negativa en ese intervalo, el area es la integral definida de -1 a 3.'},
    {topic: 'Integrales definidas', mode: 'single', statement: 'El area entre y=4x y y=4x^3 en [0,1] se calcula con la integral:', options: ['∫₀¹(4x-4x³)dx', '∫₀¹(4x³-4x)dx', '∫₀¹(4x+4x³)dx', '∫₀¹4x·4x³dx'], answerIndex: 0, explanation: 'En [0,1], la funcion 4x esta por encima de 4x³, por lo que el area es ∫(4x-4x³)dx.'}
    ],
    normal: [
    {topic: 'Integrales definidas', mode: 'single', statement: 'Considere las curvas y=-x^2+2x+3 (parabola), z (recta) y z (recta). La integral para el area de la region comprendida entre las curvas indicadas corresponde a:', options: ['∫₋₁³(-x²+2x+3)dx', '∫₋₁³(x²-2x-3)dx', '∫₋₁⁰(-x²+2x+3)dx', '∫₀³(2x+3)dx'], answerIndex: 0, explanation: 'La region esta limitada por la parabola y=-x²+2x+3 que es positiva en [-1,3].'},
    {topic: 'Bases', mode: 'single', statement: 'Cuales de los siguientes pares de vectores forman una base de R^2? u=(2,-3), v=(5,1)', options: ['No forman base', 'Si forman base, {u,v}', 'Solo cumple 2 condiciones', 'No son perpendiculares'], answerIndex: 1, explanation: 'Los vectores u y v son LI porque 2/(-3) ≠ 5/1, asi que forman base de R^2.'},
    {topic: 'Combinacion lineal', mode: 'single', statement: 'Sean u=(1,2,0) y v=(-1,0,1). Determinar si w=(1,1,1) es combinacion lineal de u y v.', options: ['No es combinacion lineal', 'Si es combinacion lineal, w = 2u + v', 'Si es combinacion lineal, w = u + 2v', 'Si es combinacion lineal, w = u - v'], answerIndex: 1, explanation: 'Resolviendo (1,1,1) = c₁(1,2,0) + c₂(-1,0,1) se obtiene c₁=2, c₂=1, entonces w=2u+v.'},
    {topic: 'Integrales definidas', mode: 'single', statement: 'Para el area entre h(x)=-2x² y f(x)=4x³, la expresion que permite calcular el area es:', options: ['∫(4x³-(-2x²))dx', '∫(4x³+(-2x²))dx', '∫|h(x)-f(x)|dx', 'Ambas a y c son validas'], answerIndex: 3, explanation: 'En intervalos donde cambia cual funcion esta arriba, se usa valor absoluto o se divide la integral.'},
    {topic: 'Bases', mode: 'single', statement: 'Una base ortogonal de R^2 es aquella cuyos vectores son:', options: ['Paralelos', 'Perpendiculares entre si', 'De modulo igual a 1', 'Tanto perpendiculares como de modulo 1'], answerIndex: 1, explanation: 'Una base ortogonal requiere vectores perpendiculares. Si ademas tienen modulo 1, es ortonormal.'},
    {topic: 'Combinacion lineal', mode: 'input', statement: 'Completa: Si w pertenece a Span(u,v), entonces w es _____ lineal de u y v.', acceptedAnswers: ['combinacion', 'combinación', 'combinacion lineal', 'combinación lineal'], explanation: 'Por definicion, Span es el conjunto de todas las combinaciones lineales posibles.'}
    ],
    hard: [
    {topic: 'Integrales definidas', mode: 'single', statement: 'Observa la figura: la expresion que permite calcular el area de la region sombreada entre cos(z)-sen(z) y sen(z) es:', options: ['∫[cos(z)-sen(z)]dz + ∫[sen(z)]dz', '∫[(cos(z)-sen(z))-sen(z)]dz', '∫[cos(z)-(2sen(z))]dz', 'Todas las anteriores considerando limites adecuados'], answerIndex: 0, explanation: 'En ciertos intervalos cos(z)-sen(z) esta arriba de sen(z), en otros es diferente, se suma segun limites.'},
    {topic: 'Combinacion lineal', mode: 'single', statement: 'Para que valores de k los vectores u=(3,k,-6), v=(-2,1,k+3), w=(1,k+2,4) son linealmente dependientes?', options: ['k = -2 y k = 6', 'Siempre son LD', 'k = 3', 'Nunca son LD'], answerIndex: 0, explanation: 'El determinante de la matriz con filas u, v, w se anula cuando k²-4k-12=0, osea k=-2 o k=6.'},
    {topic: 'Bases', mode: 'single', statement: 'Si u=(1,2,3), v=(2,1,0), w=(-1,-1,0), para que (1,-1,0) sea combinacion lineal de los tres:', options: ['Siempre es posible con cualquier coeficiente', 'No es posible porque u,v,w no forman base', 'Es posible de infinitas formas', 'Depende si (1,-1,0) pertence a Span(u,v,w)'], answerIndex: 3, explanation: 'Un vector es CL de u,v,w si y solo si pertenece al Span generado por ellos.'},
    {topic: 'Integrales definidas', mode: 'input', statement: 'Completa: El area entre dos curvas y=f(x) y y=g(x) donde f(x)≥g(x) en [a,b] es ∫ₐᵇ _____ dx', acceptedAnswers: ['f(x)-g(x)', 'f-g'], explanation: 'La formula es Area = ∫ₐᵇ[f(x)-g(x)]dx cuando f esta por encima de g.'},
    {topic: 'Bases y dimension', mode: 'single', statement: 'El conjunto de vectores {u=(1,1,1), v=(1,a,1), w=(1,1,a)} forma base de R^3 cuando:', options: ['Los tres vectores son orthonormales', 'a ≠ 1 y el determinante ≠ 0', 'Los vectores son linealmente independientes', 'b y c son equivalentes y correctas'], answerIndex: 3, explanation: 'Para base en R³ se requiere LI, lo que sucede cuando det≠0, i.e., cuando 1-a≠0, osea a≠1.'},
    {topic: 'Combinacion lineal', mode: 'single', statement: 'Dados u=(1,0), v=(0,1), el vector x=(2,-3) como combinacion lineal es:', options: ['x = 2u - 3v', 'x = 2u + 3v', 'x = 3u - 2v', 'x = -2u - 3v'], answerIndex: 0, explanation: 'Como u=(1,0) y v=(0,1) son base canonica, las coordenadas (2,-3) dan directamente 2u-3v.'}
    ]
    };
